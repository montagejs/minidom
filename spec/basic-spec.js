...
describe("minidom", function () {
    ...
    describe("parsing", function () {
        ...
        describe("elements", function () {
            ...
            it("parses attributes with namespace", function () {
                var doc = minidom(
                    '<!doctype html><html><head></head><body><svg xmlns:xlink="http://www.w3.org/1999/xlink"></svg></body></html>'
                );

                var svgElement = doc.children[0].children[1].children[0];
